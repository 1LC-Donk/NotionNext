...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '1LC.Poker', //
  BIO: process.env.NEXT_PUBLIC_BIO || '1LC_Poker Group', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.youtube.com/@1LC_Poker', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '深深水下, OneLastChip, 1LC, 深水学院', // 网站关键词 英文逗号隔开
  ...
  // 文章列表相关设置
  CAN_COPY: process.env.NEXT_PUBLIC_CAN_COPY || false, // 全栈禁止复制内容。
